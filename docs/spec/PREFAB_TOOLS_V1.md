...
| # | MCP ツール名 | wire protocol 名 | 種別 | execution_mode | timeout(ms) | retryable |
|---|---|---|---|---|---|---|
| 1 | `get_hierarchy` (prefab_path 指定) | `get_prefab_hierarchy` | read-only | sync | 10000/30000 | true |
| 2 | `get_component_info` (prefab_path 指定) | `get_prefab_component_info` | read-only | sync | 10000/30000 | true |
| 3 | `manage_component` (prefab_path 指定) | `manage_prefab_component` | edit | sync | 10000/30000 | false |
| 4 | `find_game_objects` (prefab_path 指定) | `find_prefab_game_objects` | read-only | sync | 10000/30000 | true |
| 5 | `manage_game_object` (prefab_path 指定) | `manage_prefab_game_object` | edit | sync | 10000/30000 | false |
