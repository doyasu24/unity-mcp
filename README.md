...
2. Set up a project-local `dotnet tool` version (pinned per project):
   ...
   dotnet tool install --local Doyasu24.UnityMcp.Tool --version 0.1.6
   ```
...
`https://github.com/doyasu24/unity-mcp.git?path=UnityMCPPlugin/Assets/Plugins/UnityMCP#v0.1.6`
