...
public sealed class UnitySessionRegistryTests
{
    ...
    [Fact]
    public void TryAccept_ReplacesSameProjectPath_WhenPidChangesDuringDomainReload()
    {
        var registry = new UnitySessionRegistry();
        var first = new FakeWebSocket();
        var second = new FakeWebSocket();
        registry.TryAccept(first, "45772:/Users/dys/project/Assets");

        var result = registry.TryAccept(second, "45774:/Users/dys/project/Assets");
    ...
    [Fact]
    public void TryAccept_RejectsDifferentProjectPath()
    {
        var registry = new UnitySessionRegistry();
        var first = new FakeWebSocket();
        var second = new FakeWebSocket();
        registry.TryAccept(first, "100:/Users/dys/projectA/Assets");

        var result = registry.TryAccept(second, "200:/Users/dys/projectB/Assets");
